import { isMobileEnv, debounce } from './utils';
export function createDraggableButton(
  ...
  const debounceClickEvent = debounce(clickEvent, 200);
  ...
  function dragStart(e:TouchEvent|MouseEvent) {
    ...
    if (is_in_mobile_env) {
      x_pos_start = (e as TouchEvent).touches[0].clientX;
      y_pos_start = (e as TouchEvent).touches[0].clientY;
    } else {
      x_pos_start = (e as MouseEvent).clientX;
      y_pos_start = (e as MouseEvent).clientY;
    }
  ...
  function dragging(e:TouchEvent|MouseEvent) {
    if (is_active) {
      e.preventDefault();
      if (is_in_mobile_env) {
        x_pos_end = (e as TouchEvent).touches[0].clientX;
        y_pos_end = (e as TouchEvent).touches[0].clientY;
      } else {
        x_pos_end = (e as MouseEvent).clientX;
        y_pos_end = (e as MouseEvent).clientY;
      }
